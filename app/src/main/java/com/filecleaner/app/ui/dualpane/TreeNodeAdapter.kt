...
class TreeNodeAdapter : ListAdapter<TreeNodeAdapter.FlatNode, TreeNodeAdapter.ViewHolder>(DIFF) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val info = holder.itemView.context.resources.getQuantityString(R.plurals.n_files_with_size_bullet, node.totalFileCount, node.totalFileCount, UndoHelper.formatBytes(node.totalSize))
